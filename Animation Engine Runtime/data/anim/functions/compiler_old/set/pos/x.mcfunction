data modify storage anim:runtime last_key_data_import.last_key_data.value set from storage anim:runtime got_keyframe.value.pos.x.value
data modify storage anim:runtime last_key_data_import.last_key_data.tick set from storage anim:runtime got_keyframe.tick
data modify storage anim:runtime last_key_data_import.id set value "pos.x"
data remove storage anim:runtime compile_data[{id:"pos.x"}]
...
data modify storage anim:runtime search_data append value {id:"pos.x"}
