...
execute store result score @s _anim_calc3 run data get entity @s ArmorItems[2].tag.anim_get.type 1000
...
# Extra: Ease In
execute if data entity @s ArmorItems[{tag:{anim_get:{type:2}}}] run function anim:compiler_ease_in
# Extra: Ease Out
execute if data entity @s ArmorItems[{tag:{anim_get:{type:3}}}] run function anim:compiler_ease_out

# execute store result entity @s ArmorItems[2].tag.anim_get.value float 0.001 run scoreboard players get $_comp_value _anim
execute unless data entity @s ArmorItems[{tag:{anim_get:{type:4}}}] store result entity @s ArmorItems[2].tag.anim_result.add float 0.001 run scoreboard players get @s _anim_calc4
execute if data entity @s ArmorItems[{tag:{anim_get:{type:2}}}] store result entity @s ArmorItems[2].tag.anim_result.ease_add float 0.001 run scoreboard players operation @s _anim_calc5 /= @s _anim_calc6
execute if data entity @s ArmorItems[{tag:{anim_get:{type:3}}}] store result entity @s ArmorItems[2].tag.anim_result.ease_add float -0.001 run scoreboard players get @s _anim_calc5
