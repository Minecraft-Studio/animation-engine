data modify storage anim:runtime last_key_data_import.last_key_data.value set from storage anim:runtime got_keyframe.value.l_leg.y.value
data modify storage anim:runtime last_key_data_import.last_key_data.tick set from storage anim:runtime got_keyframe.tick
data modify storage anim:runtime last_key_data_import.id set value "l_leg.y"
data remove storage anim:runtime compile_data[{id:"l_leg.y"}]
...
data modify storage anim:runtime search_data append value {id:"l_leg.y"}
