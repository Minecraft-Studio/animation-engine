...
scoreboard players operation @s _anim_calc += @s _anim_rlz
scoreboard players operation @s _anim_hx += @s _anim_rlz_ease
execute store result entity @s Pose.RightLeg[2] float 0.001 run scoreboard players get @s _anim_calc
