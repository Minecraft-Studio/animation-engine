...
execute if data entity @s ArmorItems[2].tag.anim[0].position.x.value store result entity @s Pos[0] double 0.001 run scoreboard players operation @s _anim_calc += @s _anim_px_value
execute if data entity @s ArmorItems[2].tag.anim[0].position.y.value store result score @s _anim_py_value run data get entity @s ArmorItems[2].tag.anim[0].position.y.value 1000
execute if data entity @s ArmorItems[2].tag.anim[0].position.y.value store result score @s _anim_calc as @e[tag=anim_main] if score @s _anim_ida = $_ida_lookup _anim run data get entity @s Pos[1] 1000
execute if data entity @s ArmorItems[2].tag.anim[0].position.y.value store result entity @s Pos[1] double 0.001 run scoreboard players operation @s _anim_calc += @s _anim_py_value
execute if data entity @s ArmorItems[2].tag.anim[0].position.z.value store result score @s _anim_pz_value run data get entity @s ArmorItems[2].tag.anim[0].position.z.value 1000
...
execute store result score @s _anim_px_ease run data get entity @s ArmorItems[2].tag.anim[0].position.x.ease_add 1000
execute store result score @s _anim_py_ease run data get entity @s ArmorItems[2].tag.anim[0].position.y.ease_add 1000
execute store result score @s _anim_pz_ease run data get entity @s ArmorItems[2].tag.anim[0].position.z.ease_add 1000
