...
execute as @e[tag=anim_part] if score @s _anim_ida = @e[tag=anim_part_search,limit=1] _anim_ida if score @s _anim_idb = $_got_part _anim unless score @s _anim matches 1.. run function anim:setup_anim
