...
execute positioned ~ ~ ~ run summon armor_stand ^ ^ ^3 {Marker:1b,Small:1b,Invisible:1b,CustomNameVisible:1b,CustomName:'["",{"text":"Animation Engine","color":"gray","underlined":true},{"text":" v0.9.0a","color":"aqua"}]',Tags:["anim_menu","anim_menu5","anim_menu_unsel"]}
