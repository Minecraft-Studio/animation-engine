...
execute unless data storage anim:editor result_get if data storage anim:editor search_get[0] run function anim_edit:gui/editor/run/search/get_tick_data/loop