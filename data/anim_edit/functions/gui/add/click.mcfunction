...
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu14] if score $_done _anim matches 1 run function anim_edit:gui/add/run/save
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu13] run function anim_edit:gui/add/run/cancel
