...
#data
execute if score $_exists _anim matches 1 as @e[type=armor_stand,tag=anim_menu,tag=anim_menu6] at @s run function anim_edit:gui/add/run/hover/reset/1
execute if score $_exists _anim matches 1 as @e[type=armor_stand,tag=anim_menu,tag=anim_menu7] at @s run function anim_edit:gui/add/run/hover/reset/2
execute if score $_exists _anim matches 1 as @e[type=armor_stand,tag=anim_menu,tag=anim_menu8] at @s run function anim_edit:gui/add/run/hover/reset/3
execute if score $_exists _anim matches 1 as @e[type=armor_stand,tag=anim_menu,tag=anim_menu9] at @s run function anim_edit:gui/add/run/hover/reset/4
execute if score $_exists _anim matches 1 as @e[type=armor_stand,tag=anim_menu,tag=anim_menu10] at @s run function anim_edit:gui/add/run/hover/reset/5
execute if score $_exists _anim matches 1 as @e[type=armor_stand,tag=anim_menu,tag=anim_menu11] at @s run function anim_edit:gui/add/run/hover/reset/6
