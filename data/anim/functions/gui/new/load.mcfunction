...
data remove storage anim:anim save_name
...
tellraw @p[tag=anim_user] ["",{"text":"\n\nGive the model a name: ","color":"aqua"},{"text":"click here","underlined":true,"color":"gray","clickEvent":{"action":"suggest_command","value":"/data modify storage anim:anim name set value "}},{"text":"\n"}]
