execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu1] as @e[type=armor_stand,tag=anim_menu_main] at @p[tag=anim_user] run function anim:gui/settings/load
