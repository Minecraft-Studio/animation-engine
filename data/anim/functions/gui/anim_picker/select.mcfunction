...
execute if entity @s[tag=anim_menu4] run function anim:gui/anim_picker/run/refresh_list
execute if entity @s[tag=anim_menu5] run function anim:gui/anim_picker/run/refresh_list
execute if entity @s[tag=anim_menu8] run function anim:gui/anim_picker/run/refresh_list
execute if entity @s[tag=anim_menu9] run function anim:gui/anim_picker/run/refresh_list
execute if entity @s[tag=anim_menu10] run function anim:gui/anim_picker/run/refresh_list
execute if entity @s[tag=anim_menu11] run function anim:gui/anim_picker/run/refresh_list
execute if entity @s[tag=anim_menu12] run function anim:gui/anim_picker/run/refresh_list