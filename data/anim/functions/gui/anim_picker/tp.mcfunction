...
#tick
execute if score $name_menu _anim = $show_menu _anim if score $name_id _anim matches 1..2 if data storage anim:anim name run function anim:gui/anim_picker/run/save_name
