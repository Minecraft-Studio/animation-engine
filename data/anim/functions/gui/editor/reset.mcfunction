...
execute if entity @s[tag=anim_menu90] run data merge entity @s {CustomName:'{"text":"[Save & Close]","color":"red"}'}
execute if entity @s[tag=anim_menu91] run data merge entity @s {CustomName:'{"text":"[Save]","color":"green"}'}
execute if entity @s[tag=anim_menu92] run data merge entity @s {CustomName:'{"text":"[Show Menu]","color":"blue"}'}
execute if entity @s[tag=anim_menu93] run data merge entity @s {CustomName:'{"text":"[Copy]","color":"yellow"}'}
execute if entity @s[tag=anim_menu94] run data merge entity @s {CustomName:'{"text":"[Paste]","color":"aqua"}'}