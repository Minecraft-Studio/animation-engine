...
execute if data storage anim:editor key_custom.rotate.l_arm.x run function anim:gui/editor/run/text/tab/rotate
execute unless data storage anim:editor key_custom.rotate.l_arm.x run schedule function anim:gui/editor/run/text/rotate/l_arm/custom_x_checker 1t
