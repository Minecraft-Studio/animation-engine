...
execute if data storage anim:editor key_custom.rotate.r_arm.z run function anim:gui/editor/run/text/tab/rotate
execute unless data storage anim:editor key_custom.rotate.r_arm.z run schedule function anim:gui/editor/run/text/rotate/r_arm/custom_z_checker 1t
