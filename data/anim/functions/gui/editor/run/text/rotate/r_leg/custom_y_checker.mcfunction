...
execute if data storage anim:editor key_custom.rotate.r_leg.y run function anim:gui/editor/run/text/tab/rotate
execute unless data storage anim:editor key_custom.rotate.r_leg.y run schedule function anim:gui/editor/run/text/rotate/r_leg/custom_y_checker 1t
