...
execute if data storage anim:editor key_custom.position.z run function anim:gui/editor/run/text/tab/rotate
execute unless data storage anim:editor key_custom.position.z run schedule function anim:gui/editor/run/text/position/custom_z_checker 1t
