...
execute if score $_tmp_clipboard_exists _anim matches 1 if score $_paste_sel_exists _anim matches 1 run function anim:gui/editor/run/text/tab/rotate
execute if score $_tmp_clipboard_exists _anim matches 1 if score $_paste_sel_exists _anim matches 1 as @e[type=armor_stand,tag=anim_menu,tag=anim_editor,tag=anim_editor_sel,limit=1] run function anim:gui/editor/run/save_keyframe
execute if score $_tmp_clipboard_exists _anim matches 1 if score $_paste_sel_exists _anim matches 1 run function anim:gui/editor/run/search/load_all_keyframes/start
