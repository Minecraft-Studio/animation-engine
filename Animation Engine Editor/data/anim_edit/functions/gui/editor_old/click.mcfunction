...
#execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu7] as @e[type=armor_stand,tag=anim_menu_main] at @s run function anim_edit:gui/new/load

execute as @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu92] run function anim_edit:gui/editor/load
