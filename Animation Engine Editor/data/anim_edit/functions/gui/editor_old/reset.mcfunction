...
execute unless score $editor_play _anim matches 1 if entity @s[tag=anim_menu80] run data merge entity @s {CustomName:'{"text":"▶","color":"gray"}'}
execute unless score $editor_play _anim matches 1 if entity @s[tag=anim_menu94] run data merge entity @s {CustomName:'{"text":"|▶","color":"gray"}'}
execute if score $editor_play _anim matches 1 if entity @s[tag=anim_menu80] run data merge entity @s {CustomName:'{"text":"⏸","color":"gray"}'}
execute if score $editor_play _anim matches 2 if entity @s[tag=anim_menu80] run data merge entity @s {CustomName:'{"text":"▶","color":"gray"}'}
execute if score $editor_play _anim matches 1..2 if entity @s[tag=anim_menu94] run data merge entity @s {CustomName:'{"text":"■","color":"gray"}'}
...
execute if entity @s[tag=anim_menu87] run data merge entity @s {CustomName:'{"text":"↓","color":"yellow"}'}
execute if score $anim_page _anim matches ..1 if entity @s[tag=anim_menu93] run data merge entity @s {CustomName:'{"text":"↑","color":"gray"}'}
execute if score $anim_page _anim matches 2.. if entity @s[tag=anim_menu93] run data merge entity @s {CustomName:'{"text":"↑","color":"yellow"}'}
