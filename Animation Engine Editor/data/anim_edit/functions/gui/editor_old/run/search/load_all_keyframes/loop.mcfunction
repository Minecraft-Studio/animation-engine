...
execute unless data storage anim:editor search[] as @e[type=armor_stand,tag=anim_editor] run function anim_edit:gui/editor/reset
execute if data storage anim:editor search[] run function anim_edit:gui/editor/run/search/load_all_keyframes/loop