...
execute unless score $_api_endcomp _anim matches 5 as @e[tag=anim_part] if score @s _anim_ida = @e[tag=anim_model_select,limit=1] _anim_ida if score @s _anim_idb = $_get_part _anim run data modify entity @s ArmorItems[2].tag.anim set from storage anim:editor result_comp
execute unless score $_api_endcomp _anim matches 5 as @e[tag=anim_part] if score @s _anim_ida = @e[tag=anim_model_select,limit=1] _anim_ida if score @s _anim_idb = $_get_part _anim unless data storage anim:editor result_comp run data remove entity @s ArmorItems[2].tag.anim
...
execute if score $_api_endcomp _anim matches 5 as @e[tag=anim_part] if score @s _anim_ida = @e[tag=anim_model_select,limit=1] _anim_ida if score @s _anim_idb = $_get_part _anim run data modify storage anim:editor tmp_anim_from set from entity @s ArmorItems[2].tag.animations
execute if score $_api_endcomp _anim matches 5 run function anim_edit:gui/editor/run/search/compile/save_loop
execute if score $_api_endcomp _anim matches 5 as @e[tag=anim_part] if score @s _anim_ida = @e[tag=anim_model_select,limit=1] _anim_ida if score @s _anim_idb = $_get_part _anim run data modify entity @s ArmorItems[2].tag.animations set from storage anim:editor tmp_anim_result
