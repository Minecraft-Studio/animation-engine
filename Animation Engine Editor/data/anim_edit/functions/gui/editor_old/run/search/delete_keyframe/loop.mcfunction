...
execute unless data storage anim:editor search[] unless score $_api_enddel _anim matches 1 run tellraw @s {"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n"}
execute unless data storage anim:editor search[] unless score $_api_enddel _anim matches 1 run tellraw @s [{"text":"Successfully deleted keyframe ","color":"red"},{"score":{"name":"$_dkey_col","objective":"_anim"},"color":"dark_red"},{"text":" in row ","color":"red"},{"score":{"name":"$_dkey_row","objective":"_anim"},"color":"dark_red"}]
execute unless data storage anim:editor search[] if score $_api_enddel _anim matches 1 run tellraw @s [{"text":"Bad Keyframe ","color":"red"},{"score":{"name":"$_dkey_col","objective":"_anim"},"color":"dark_red"},{"text":" in row ","color":"red"},{"score":{"name":"$_dkey_row","objective":"_anim"},"color":"dark_red"},{"text":" deleted"}]
