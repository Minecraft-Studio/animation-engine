...
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu2] run function anim_edit:gui/settings/load
...
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu13] run function anim_edit:gui/anim_picker/run/change_list
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu6] run function anim_edit:gui/anim_picker/run/next
...
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu4] run function anim_edit:gui/anim_picker/run/select_anim
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu5] run function anim_edit:gui/anim_picker/run/select_anim
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu8] run function anim_edit:gui/anim_picker/run/select_anim
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu9] run function anim_edit:gui/anim_picker/run/select_anim
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu10] run function anim_edit:gui/anim_picker/run/select_anim
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu11] run function anim_edit:gui/anim_picker/run/select_anim
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu12] run function anim_edit:gui/anim_picker/run/select_anim
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu14] unless score $name_id _anim matches 1 run function anim_edit:gui/anim_picker/run/edit_name
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu15] unless score $name_id _anim matches 1 run function anim_edit:gui/anim_picker/run/confirm_delete
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu6] unless score $name_id _anim matches 1 run function anim_edit:gui/editor/load
