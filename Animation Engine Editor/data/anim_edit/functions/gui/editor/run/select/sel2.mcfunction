...
# loads text editor
execute if entity @s[tag=anim_editor0] run function anim_edit:gui/editor/run/text/load_empty
...
execute if entity @s[tag=!anim_editor0] run function anim_edit:gui/editor/run/text/tab/rotate
