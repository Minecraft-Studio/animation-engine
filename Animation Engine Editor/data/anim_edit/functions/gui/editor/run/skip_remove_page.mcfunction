...
scoreboard players operation $_tmp_old_pg _anim = $page _anim
scoreboard players remove $page _anim 5
execute if score $page _anim matches ..0 run scoreboard players set $page _anim 1
