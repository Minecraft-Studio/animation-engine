...
execute unless data storage anim:editor key_custom.rotate.l_leg.z run schedule function anim_edit:gui/editor/run/text/rotate/l_leg/custom_z_checker 1t
