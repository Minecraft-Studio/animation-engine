...
scoreboard players operation $_tick_selected _anim = @e[type=armor_stand,tag=anim_sel_menu,scores={_anim_editor_col=1..},limit=1] _anim_editor_col
scoreboard players operation $_tick_selected_page _anim = $_page _anim
scoreboard players operation $_tick_selected _anim += $_tick_selected_page _anim
...
execute as @p[tag=anim_user] at @s unless score $_tick_selected_insec_dec _anim matches ..9 if block ~ ~ ~ air run setblock ~ ~ ~ oak_sign{Text1:'["",{"score":{"name":"$_tick_selected","objective":"_anim"},"color":"gold"},{"text":"t ","color":"gold"},{"score":{"name":"$_tick_selected_insec","objective":"_anim"},"color":"yellow"},{"text":".","color":"yellow"},{"score":{"name":"$_tick_selected_insec_dec","objective":"_anim"},"color":"yellow"},{"text":"s","color":"yellow"}]'}
execute as @p[tag=anim_user] at @s if score $_tick_selected_insec_dec _anim matches ..9 if block ~ ~ ~ air run setblock ~ ~ ~ oak_sign{Text1:'["",{"score":{"name":"$_tick_selected","objective":"_anim"},"color":"gold"},{"text":"t ","color":"gold"},{"score":{"name":"$_tick_selected_insec","objective":"_anim"},"color":"yellow"},{"text":".0","color":"yellow"},{"score":{"name":"$_tick_selected_insec_dec","objective":"_anim"},"color":"yellow"},{"text":"s","color":"yellow"}]'}
