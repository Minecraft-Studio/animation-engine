...
execute if entity @e[type=armor_stand,tag=anim_editor_sel_had] run tag @e[tag=anim_editor_sel_had] add anim_editor_sel
execute if entity @e[type=armor_stand,tag=anim_editor_sel_had] run tag @e[tag=anim_editor_sel_had] remove anim_editor_sel_had
