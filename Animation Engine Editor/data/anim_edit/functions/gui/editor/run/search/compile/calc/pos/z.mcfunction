...
execute if data storage anim:editor last_compile_keyframe.position.z.value store result storage anim:editor temp_get1 int 1 run data get storage anim:editor last_compile_keyframe.position.z.value 1000
execute if data storage anim:editor last_compile_keyframe.position.z.value store result score $_comp_calc1 _anim run data get storage anim:editor temp_get1
execute if data storage anim:editor last_compile_keyframe.position.z.value run data remove storage anim:editor temp_get1
