...
execute if data storage anim:editor last_compile_keyframe.rotate.head.x.value store result score $_comp_calc1 _anim run data get storage anim:editor last_compile_keyframe.rotate.head.x.value 1000
...
# Extra: Ease Out
execute if data storage anim:editor last_compile_keyframe.rotate.head.x.value if data storage anim:editor {result_comp_tick:{extra:{rotate:3}}} run scoreboard players operation $_comp_value_ease_add _anim = $_comp_value_add _anim
execute if data storage anim:editor last_compile_keyframe.rotate.head.x.value if data storage anim:editor {result_comp_tick:{extra:{rotate:3}}} run scoreboard players operation $_comp_value_ease_add _anim *= $1000 _anim
execute if data storage anim:editor last_compile_keyframe.rotate.head.x.value if data storage anim:editor {result_comp_tick:{extra:{rotate:3}}} run scoreboard players operation $_comp_value_tick2 _anim = $_comp_value_tick _anim
execute if data storage anim:editor last_compile_keyframe.rotate.head.x.value if data storage anim:editor {result_comp_tick:{extra:{rotate:3}}} run scoreboard players operation $_comp_value_tick3 _anim = $_comp_value_tick _anim
execute if data storage anim:editor last_compile_keyframe.rotate.head.x.value if data storage anim:editor {result_comp_tick:{extra:{rotate:3}}} run scoreboard players operation $_comp_value_add _anim /= $_comp_value_tick2 _anim
execute if data storage anim:editor last_compile_keyframe.rotate.head.x.value if data storage anim:editor {result_comp_tick:{extra:{rotate:3}}} run scoreboard players operation $_comp_value_tick2 _anim *= $1000 _anim
execute if data storage anim:editor last_compile_keyframe.rotate.head.x.value if data storage anim:editor {result_comp_tick:{extra:{rotate:3}}} run scoreboard players operation $_comp_value_tick2 _anim /= $2 _anim
execute if data storage anim:editor last_compile_keyframe.rotate.head.x.value if data storage anim:editor {result_comp_tick:{extra:{rotate:3}}} run scoreboard players operation $_comp_value_ease_add _anim /= $_comp_value_tick2 _anim
execute if data storage anim:editor last_compile_keyframe.rotate.head.x.value if data storage anim:editor {result_comp_tick:{extra:{rotate:3}}} run function anim_edit:gui/editor/run/search/compile/ease_out_loop
...
execute if data storage anim:editor last_compile_keyframe.rotate.head.x.value unless data storage anim:editor {result_comp_tick:{extra:{rotate:4}}} store result storage anim:editor result_comp_tick_old.rotate.head.x.add float 0.001 run scoreboard players get $_comp_value_add _anim
...
execute if data storage anim:editor last_compile_keyframe.rotate.head.x.value if data storage anim:editor {result_comp_tick:{extra:{rotate:3}}} store result storage anim:editor result_comp_tick_old.rotate.head.x.ease_add float -0.001 run scoreboard players get $_comp_value_ease_add _anim
...
execute if data storage anim:editor last_compile_keyframe.rotate.head.x.value unless data storage anim:editor {result_comp_tick:{extra:{rotate:4}}} store result storage anim:editor last_compile_keyframe.rotate.head.x.add float 0.001 run scoreboard players get $_comp_value_add _anim