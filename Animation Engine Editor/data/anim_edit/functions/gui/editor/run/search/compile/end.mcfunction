...
execute if score $_api_endcomp _anim matches 3 as @e[tag=anim_part] if score @s _anim_ida = @e[tag=anim_main_select,limit=1] _anim_ida run function anim:setup_anim
