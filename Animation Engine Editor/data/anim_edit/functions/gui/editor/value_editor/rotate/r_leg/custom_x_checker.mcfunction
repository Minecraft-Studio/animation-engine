...
execute unless data storage anim:editor key_custom.rotate.r_leg.x run schedule function anim_edit:gui/editor/run/text/rotate/r_leg/custom_x_checker 1t
