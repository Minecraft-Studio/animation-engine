...
execute unless data storage anim:editor key_custom.rotate.l_arm.x run schedule function anim_edit:gui/editor/value_editor/rotate/l_arm/custom_x_checker 1t
