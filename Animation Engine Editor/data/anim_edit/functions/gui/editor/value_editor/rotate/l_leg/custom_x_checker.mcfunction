...
execute unless data storage anim:editor key_custom.rotate.l_leg.x run schedule function anim_edit:gui/editor/run/text/rotate/l_leg/custom_x_checker 1t
