...
execute unless data storage anim:editor key_custom.rotate.l_leg.y run schedule function anim_edit:gui/editor/run/text/rotate/l_leg/custom_y_checker 1t
