...
execute unless data storage anim:editor key_custom.rotate.r_arm.y run schedule function anim_edit:gui/editor/run/text/rotate/r_arm/custom_y_checker 1t
