...
execute unless data storage anim:editor key_custom.rotate.r_arm.x run schedule function anim_edit:gui/editor/run/text/rotate/r_arm/custom_x_checker 1t
