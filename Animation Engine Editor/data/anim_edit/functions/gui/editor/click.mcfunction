...
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu89] run function anim_edit:gui/editor/run/search/delete_keyframe/start
...
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu93] run function anim_edit:gui/editor/run/copy_keyframe
execute if entity @e[type=armor_stand,tag=anim_sel_menu,tag=anim_menu94] run function anim_edit:gui/editor/run/paste_keyframe
