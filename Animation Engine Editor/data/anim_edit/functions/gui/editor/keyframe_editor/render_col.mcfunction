...
execute if score $_get_tick _anim = @s _anim_editor_col if score $_get_part _anim = @s _anim_idb_select run scoreboard players set $_key_selected _anim 1
#sets if keyframe is selected by anyone
scoreboard players reset $_key_selected_all _anim
execute as @a if score $_get_tick _anim = @s _anim_editor_col if score $_get_part _anim = @s _anim_idb_select run scoreboard players set $_key_selected_all _anim 1
