...
execute if score $_got_p_id _anim = @s _anim_id_player run data modify storage anim:editor open_keyframes append from storage anim:editor search_for_opened_keyframes[0]
