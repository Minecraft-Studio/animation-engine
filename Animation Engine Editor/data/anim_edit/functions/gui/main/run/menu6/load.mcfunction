...
#>ID
execute unless score $prev_idb _anim matches 1.. run tellraw @p[tag=anim_user] ["",{"text":"Anim part ID:","color":"gray","hoverEvent":{"action": "show_text","contents":{"text":"The assigned ID for this part","color":"gray"}}},{"text":" <","color":"gray"}," ",{"score":{"name":"@e[tag=anim_part_select,limit=1]","objective":"_anim_idb"},"color":"white"},{"text":" >","color":"yellow","hoverEvent":{"action":"show_text","contents":[{"text":"Next: ","color":"gray"},{"score":{"name": "$next_idb","objective": "_anim"}}]},"clickEvent": {"action": "run_command","value":"/function anim_edit:gui/main/run/idb/next"}}]
execute if score $prev_idb _anim matches 1.. run tellraw @p[tag=anim_user] ["",{"text":"Anim part ID:","color":"gray","hoverEvent":{"action": "show_text","contents":{"text":"The assigned ID for this part","color":"gray"}}},{"text":" <","color":"yellow","hoverEvent":{"action":"show_text","contents":[{"text":"Previous: ","color":"gray"},{"score":{"name": "$prev_idb","objective": "_anim"}}]},"clickEvent": {"action": "run_command","value":"/function anim_edit:gui/main/run/idb/prev"}}," ",{"score":{"name":"@e[tag=anim_part_select,limit=1]","objective":"_anim_idb"},"color":"white"},{"text":" >","color":"yellow","hoverEvent":{"action":"show_text","contents":[{"text":"Next: ","color":"gray"},{"score":{"name": "$next_idb","objective": "_anim"}}]},"clickEvent": {"action": "run_command","value":"/function anim_edit:gui/main/run/idb/next"}}]
#>Line space
tellraw @p[tag=anim_user] ""
#>Inventory
execute if data entity @e[tag=anim_part_select,limit=1] ArmorItems[3].id run tellraw @p[tag=anim_user] [{"text":"[Head: ","color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"Click to set it to the item you are holding","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/function anim_edit:gui/main/run/menu6/item/head"}},{"nbt":"ArmorItems[3].id","entity":"@e[tag=anim_part_select,limit=1]","color":"#ffa2a2"},"]"]
execute unless data entity @e[tag=anim_part_select,limit=1] ArmorItems[3].id run tellraw @p[tag=anim_user] [{"text":"[Head: ","color":"red","hoverEvent":{"action":"show_text","contents":[{"text":"Click to set it to the item you are holding","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/function anim_edit:gui/main/run/menu6/item/head"}},{"text":"none","color":"gray"},"]"]

execute if data entity @e[tag=anim_part_select,limit=1] ArmorItems[2].id run tellraw @p[tag=anim_user] [{"text":"[Body: ","color":"blue","hoverEvent":{"action":"show_text","contents":[{"text":"Click to set it to the item you are holding","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/function anim_edit:gui/main/run/menu6/item/body"}},{"nbt":"ArmorItems[2].id","entity":"@e[tag=anim_part_select,limit=1]","color":"#a2a2ff"},"]"]
...
execute if data entity @e[tag=anim_part_select,limit=1] HandItems[0].id run tellraw @p[tag=anim_user] [{"text":"[Right Arm: ","color":"dark_purple","hoverEvent":{"action":"show_text","contents":[{"text":"Click to set it to the item you are holding","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/function anim_edit:gui/main/run/menu6/item/r_arm"}},{"nbt":"HandItems[0].id","entity":"@e[tag=anim_part_select,limit=1]","color":"#d073d0"},"]"]
execute unless data entity @e[tag=anim_part_select,limit=1] HandItems[0].id run tellraw @p[tag=anim_user] [{"text":"[Right Arm: ","color":"dark_purple","hoverEvent":{"action":"show_text","contents":[{"text":"Click to set it to the item you are holding","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/function anim_edit:gui/main/run/menu6/item/r_arm"}},{"text":"none","color":"gray"},"]"]

execute if data entity @e[tag=anim_part_select,limit=1] HandItems[1].id run tellraw @p[tag=anim_user] [{"text":"[Left Arm: ","color":"light_purple","hoverEvent":{"action":"show_text","contents":[{"text":"Click to set it to the item you are holding","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/function anim_edit:gui/main/run/menu6/item/l_arm"}},{"nbt":"HandItems[1].id","entity":"@e[tag=anim_part_select,limit=1]","color":"#ffa2ff"},"]"]
execute unless data entity @e[tag=anim_part_select,limit=1] HandItems[1].id run tellraw @p[tag=anim_user] [{"text":"[Left Arm: ","color":"light_purple","hoverEvent":{"action":"show_text","contents":[{"text":"Click to set it to the item you are holding","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/function anim_edit:gui/main/run/menu6/item/l_arm"}},{"text":"none","color":"gray"},"]"]

execute if data entity @e[tag=anim_part_select,limit=1] ArmorItems[1].id run tellraw @p[tag=anim_user] [{"text":"[Leggings: ","color":"dark_green","hoverEvent":{"action":"show_text","contents":[{"text":"Click to set it to the item you are holding","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/function anim_edit:gui/main/run/menu6/item/legg"}},{"nbt":"ArmorItems[1].id","entity":"@e[tag=anim_part_select,limit=1]","color":"#73d073"},"]"]
execute unless data entity @e[tag=anim_part_select,limit=1] ArmorItems[1].id run tellraw @p[tag=anim_user] [{"text":"[Leggings: ","color":"dark_green","hoverEvent":{"action":"show_text","contents":[{"text":"Click to set it to the item you are holding","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/function anim_edit:gui/main/run/menu6/item/legg"}},{"text":"none","color":"gray"},"]"]

execute if data entity @e[tag=anim_part_select,limit=1] ArmorItems[0].id run tellraw @p[tag=anim_user] [{"text":"[Boots: ","color":"green","hoverEvent":{"action":"show_text","contents":[{"text":"Click to set it to the item you are holding","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/function anim_edit:gui/main/run/menu6/item/boots"}},{"nbt":"ArmorItems[0].id","entity":"@e[tag=anim_part_select,limit=1]","color":"#a2ffa2"},"]"]
execute unless data entity @e[tag=anim_part_select,limit=1] ArmorItems[0].id run tellraw @p[tag=anim_user] [{"text":"[Boots: ","color":"green","hoverEvent":{"action":"show_text","contents":[{"text":"Click to set it to the item you are holding","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/function anim_edit:gui/main/run/menu6/item/boots"}},{"text":"none","color":"gray"},"]"]
#>Line space
tellraw @p[tag=anim_user] ""
#>Menu Buttons
# If new Anim Part:
execute if entity @e[tag=anim_part_select,tag=anim_part_new] run tellraw @p[tag=anim_user] ["",{"text":"[Cancel]","color":"red","hoverEvent":{"action":"show_text","contents":{"text":"Cancels and deletes the anim part","color":"gray"}},"clickEvent": {"action": "run_command","value": "/execute if entity @e[tag=anim_part_select,tag=anim_part_new] run function anim_edit:gui/main/run/menu6/delete"}}," ",{"text":"[Save]","color":"green","hoverEvent":{"action": "show_text","contents":{"text":"Saves data and goes back","color":"gray"}},"clickEvent":{"action":"run_command","value":"/execute if entity @e[tag=anim_part_select] run function anim_edit:gui/main/run/menu6/save"}}]
