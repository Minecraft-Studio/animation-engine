...
execute as @s at @s if block ~ ~ ~ air run setblock ~ ~ ~ oak_sign{Text1:'{"nbt":"anim_part_cname","storage":"anim:editor"}'}
execute as @s at @s run data modify entity @e[type=armor_stand,tag=anim_part_select,limit=1] CustomName set from block ~ ~ ~ Text1
