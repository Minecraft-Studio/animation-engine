...
execute if score $_del_api _anim matches 1.. run data modify entity @e[tag=anim_model_select,limit=1] ArmorItems[2].tag.animations set from storage anim:editor tmp_anim_data_result
