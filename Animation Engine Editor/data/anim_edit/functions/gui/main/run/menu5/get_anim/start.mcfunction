...
#>Gets Animation data
# Input: anim:editor tmp_anim_main_data; $_id_search _anim
# Output: anim:editor anim_data
data modify storage anim:editor tmp_anim_data_search set from storage anim:editor tmp_anim_main_data
