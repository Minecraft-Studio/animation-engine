...
execute as @e[tag=anim_part] if score @s _anim_ida = @e[tag=anim_model_select,limit=1] _anim_ida if score @s _anim_idb = $lookfor_idb _anim run scoreboard players set $_found_idb _anim 1
