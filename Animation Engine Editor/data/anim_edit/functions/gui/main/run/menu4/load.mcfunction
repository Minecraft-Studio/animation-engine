...
#>Name
execute unless score $_curr_air _anim matches 1 run tellraw @s [{"text":"Anim model name: ","color":"gray","hoverEvent":{"action": "show_text","contents":{"text":"Click to set a new name","color":"gray"}},"clickEvent": {"action":"suggest_command","value":"/data modify storage anim:editor anim_model_cname set value "}},{"nbt":"CustomName","entity":"@e[tag=anim_main_select,limit=1]","interpret":true,"color":"green"}]
...
#>ID (FIX)
execute unless score $prev_ida _anim matches 1.. run tellraw @s ["",{"text":"Anim model ID:","color":"gray","hoverEvent":{"action": "show_text","contents":{"text":"The assigned ID for this model","color":"gray"}}},{"text":" <","color":"gray"}," ",{"score":{"name":"@e[tag=anim_main_select,limit=1]","objective":"_anim_ida"},"color":"white"},{"text":" >","color":"yellow","hoverEvent":{"action":"show_text","contents":[{"text":"Next: ","color":"gray"},{"score":{"name": "$next_ida","objective": "_anim"}}]},"clickEvent": {"action": "run_command","value":"/function anim_edit:gui/main/run/ida/next"}}]
execute if score $prev_ida _anim matches 1.. run tellraw @s ["",{"text":"Anim model ID:","color":"gray","hoverEvent":{"action": "show_text","contents":{"text":"The assigned ID for this model","color":"gray"}}},{"text":" <","color":"yellow","hoverEvent":{"action":"show_text","contents":[{"text":"Previous: ","color":"gray"},{"score":{"name": "$prev_ida","objective": "_anim"}}]},"clickEvent": {"action": "run_command","value":"/function anim_edit:gui/main/run/ida/prev"}}," ",{"score":{"name":"@e[tag=anim_main_select,limit=1]","objective":"_anim_ida"},"color":"white"},{"text":" >","color":"yellow","hoverEvent":{"action":"show_text","contents":[{"text":"Next: ","color":"gray"},{"score":{"name": "$next_ida","objective": "_anim"}}]},"clickEvent": {"action": "run_command","value":"/function anim_edit:gui/main/run/ida/next"}}]


#tellraw @s [{"text":"Anim model ID:","color":"gray","hoverEvent":{"action": "show_text","contents":{"text":"The assigned ID for this model (Currently non-changable, planned feature)","color":"gray"}}},{"text":" <"}," ",{"score":{"name":"@e[tag=anim_main_select,limit=1]","objective":"_anim_ida"},"color":"white"},{"text":" >"}]
...
execute unless entity @e[tag=anim_part_menu] if entity @e[tag=anim_main_select,tag=!anim_main_new] run tellraw @s ["",{"text":"[Delete]","color":"red","hoverEvent":{"action":"show_text","contents":{"text":"Deletes anim model and it's anim parts","color":"red"}},"clickEvent": {"action": "run_command","value": "/execute if entity @e[tag=anim_main_select,tag=!anim_main_new] run function anim_edit:gui/main/run/menu4/delete_confirm"}}," ",{"text":"[Duplicate]","color":"aqua","hoverEvent":{"action":"show_text","contents":{"text":"Duplicate anim model, its anim parts and animations to a new anim model","color":"gray"}},"clickEvent": {"action": "run_command","value": "/execute if entity @e[tag=anim_main_select,tag=!anim_main_new] run function anim_edit:gui/main/run/menu4/duplicate"}}," ",{"text":"[Save]","color":"gray","hoverEvent":{"action":"show_text","contents":[{"text":"Saves data and goes back to animations menu","color":"gray"},{"text":"\nRequires at least 1 connected anim_part","color":"red"}]}}]
