...
execute as @s at @s if block ~ ~ ~ air run setblock ~ ~ ~ oak_sign{Text1:'{"nbt":"anim_main_cname","storage":"anim:editor"}'}
...
execute if score $_sign_placed _anim matches 1 run data remove storage anim:editor anim_main_cname
