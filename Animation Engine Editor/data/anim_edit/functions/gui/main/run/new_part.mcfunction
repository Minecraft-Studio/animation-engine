...
execute at @e[tag=anim_main_select] run summon armor_stand ~ ~ ~ {Tags:["anim_part","anim","anim_part_new","anim_part_select"],Invisible:0b,NoGravity:1b,Marker:1b,Glowing:1,CustomName:'{"text":"Unnamed Anim Part"}',ArmorItems:[{},{},{id:"minecraft:stone",Count:1b},{}]}
