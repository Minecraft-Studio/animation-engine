...
summon armor_stand ~ ~ ~ {Marker:1b,Small:1b,Invisible:1b,CustomNameVisible:1b,CustomName:'["",{"text":"Animation Engine","color":"gray","underlined":true},{"text":" v1.0a2","color":"aqua"}]',Tags:["anim_menu","anim_menu5","anim_menu_unsel"]}
