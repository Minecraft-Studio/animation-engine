...
execute if score $_got_p_id _anim = $_p_id _anim if data entity @e[tag=anim_custom_nbt_tp,tag=anim_settings,limit=1] ArmorItems[2].tag.e.remove3 run data modify storage anim:editor search_edit_shortcuts[0].remove3 set from storage anim:editor import_edit_shortcuts
execute if score $_got_p_id _anim = $_p_id _anim if data entity @e[tag=anim_custom_nbt_tp,tag=anim_settings,limit=1] ArmorItems[2].tag.e.remove2 run data modify storage anim:editor search_edit_shortcuts[0].remove2 set from storage anim:editor import_edit_shortcuts
execute if score $_got_p_id _anim = $_p_id _anim if data entity @e[tag=anim_custom_nbt_tp,tag=anim_settings,limit=1] ArmorItems[2].tag.e.remove1 run data modify storage anim:editor search_edit_shortcuts[0].remove1 set from storage anim:editor import_edit_shortcuts
execute if score $_got_p_id _anim = $_p_id _anim if data entity @e[tag=anim_custom_nbt_tp,tag=anim_settings,limit=1] ArmorItems[2].tag.e.add1 run data modify storage anim:editor search_edit_shortcuts[0].add1 set from storage anim:editor import_edit_shortcuts
execute if score $_got_p_id _anim = $_p_id _anim if data entity @e[tag=anim_custom_nbt_tp,tag=anim_settings,limit=1] ArmorItems[2].tag.e.add2 run data modify storage anim:editor search_edit_shortcuts[0].add2 set from storage anim:editor import_edit_shortcuts
execute if score $_got_p_id _anim = $_p_id _anim if data entity @e[tag=anim_custom_nbt_tp,tag=anim_settings,limit=1] ArmorItems[2].tag.e.add3 run data modify storage anim:editor search_edit_shortcuts[0].add3 set from storage anim:editor import_edit_shortcuts
...
execute if data storage anim:editor search_edit_shortcuts[0] run function anim_edit:gui/settings/run/set_edit_shortcuts_loop
