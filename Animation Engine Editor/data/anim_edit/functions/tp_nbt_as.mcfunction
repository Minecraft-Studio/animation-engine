...
# check for value
execute if data entity @e[tag=anim_custom_nbt_tp,tag=anim_settings,limit=1] ArmorItems[2].tag.p run function anim_edit:gui/settings/run/set_shortcuts
execute if data entity @e[tag=anim_custom_nbt_tp,tag=anim_settings,limit=1] ArmorItems[2].tag.m run function anim_edit:gui/settings/run/set_shortcuts
# reset 
