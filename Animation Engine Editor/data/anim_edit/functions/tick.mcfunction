...
#this is disabled for now since it is no longer being used
...
execute as @a if score @s _anim_id_player matches -2147483648..2147483647 at @s run function anim_edit:tp_nbt_as