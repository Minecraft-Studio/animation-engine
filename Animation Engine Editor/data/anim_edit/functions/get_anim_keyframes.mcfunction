...
execute unless data storage anim:editor search_anim_data unless entity @s[tag=anim_main] run function anim_edit:search_model
execute unless data storage anim:editor search_anim_data unless entity @s[tag=anim_main] run data modify storage anim:editor search_anim_data set from entity @e[tag=anim_main_select,limit=1] ArmorItems[2].tag.animations
execute unless data storage anim:editor search_anim_data if entity @s[tag=anim_main] run data modify storage anim:editor search_anim_data set from entity @s ArmorItems[2].tag.animations
